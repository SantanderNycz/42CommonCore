...
/*   Updated: 2025/08/12 17:43:07 by lsantand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     open_imgs(void *mlx, t_game *game)
{
    ...
    a->bg_1 = mlx_xpm_file_to_image(mlx, "./assets/bg_1.xpm", t, t);
...
{
    if (g->assets.bg_2_1)
        mlx_destroy_img(g->mlx, g->assets.bg_2_1);
    if (g->assets.bg_2_2)
        mlx_destroy_img(g->mlx, g->assets.bg_2_2);
    if (g->assets.bg_1)
        mlx_destroy_img(g->mlx, g->assets.bg_1);
    if (g->assets.chest_o)
        mlx_destroy_img(g->mlx, g->assets.chest_o);
    if (g->assets.chest)
        mlx_destroy_img(g->mlx, g->assets.chest);
    if (g->assets.wall)
        mlx_destroy_img(g->mlx, g->assets.wall);
    if (g->assets.exit)
        mlx_destroy_img(g->mlx, g->assets.exit);
    if (g->assets.player)
        mlx_destroy_img(g->mlx, g->assets.player);
    return (0);
}
...
{
    if (g->assets.wall_bl)
        mlx_destroy_img(g->mlx, g->assets.wall_bl);
    if (g->assets.wall_br)
        mlx_destroy_img(g->mlx, g->assets.wall_br);
    if (g->assets.wall_tl)
        mlx_destroy_img(g->mlx, g->assets.wall_tl);
    if (g->assets.wall_tr)
        mlx_destroy_img(g->mlx, g->assets.wall_tr);
    if (g->assets.wall_t)
        mlx_destroy_img(g->mlx, g->assets.wall_t);
    if (g->assets.wall_b)
        mlx_destroy_img(g->mlx, g->assets.wall_b);
    if (g->assets.wall_l)
        mlx_destroy_img(g->mlx, g->assets.wall_l);
    if (g->assets.wall_r)
        mlx_destroy_img(g->mlx, g->assets.wall_r);
    return (0);
}